  ...
  */
  ...
  class ezSQL_mysql extends ezSQLcore
  {
    ...
    */
    ...
    private function ezSQL_mysql($dbuser='', $dbpassword='', $dbname='', $dbhost='localhost', $encoding='')
    {
      $this->dbuser = $dbuser;
    ...
    public static function get_instance($dbuser='', $dbpassword='', $dbname='', $dbhost='localhost', $encoding='')
    {
        if(empty(ezSQL_mysql::$instance))
            ezSQL_mysql::$instance = new ezSQL_mysql($dbuser, $dbpassword, $dbname, $dbhost, $encoding);

        return ezSQL_mysql::$instance;
    }
    /**********************************************************************
